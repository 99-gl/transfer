...
#
# Generates only setup.golden.json for the aes_routed_raw checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_routed_raw.enc\",\"stage\":\"aes_routed_raw\",\"analysis\":\"setup\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
