...
#
# Generates only hold.golden.json for the aes_cts checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_cts.enc\",\"stage\":\"aes_cts\",\"analysis\":\"hold\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
