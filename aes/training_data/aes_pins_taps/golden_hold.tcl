...
#
# Generates only hold.golden.json for the aes_pins_taps checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_pins_taps.enc\",\"stage\":\"aes_pins_taps\",\"analysis\":\"hold\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
