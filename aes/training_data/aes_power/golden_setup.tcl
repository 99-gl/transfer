...
#
# Generates only setup.golden.json for the aes_power checkpoint.
# Run report_setup.tcl first so the report Beginpoint is available.

set SCRIPT_DIR [file dirname [file normalize [info script]]]
set CHECKPOINT /home/host/aes_baseline/outputs/aes_power.enc
set DATABASE /home/host/aes_baseline/outputs/aes_power.enc.dat
...
puts $fh "{\"checkpoint\":\"aes_power.enc\",\"stage\":\"aes_power\",\"analysis\":\"setup\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
