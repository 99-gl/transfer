...
#
# Generates only setup.golden.json for the aes_floorplan checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_floorplan.enc\",\"stage\":\"aes_floorplan\",\"analysis\":\"setup\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
