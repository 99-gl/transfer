...
#
# Generates only hold.golden.json for the aes_route checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_route.enc\",\"stage\":\"aes_route\",\"analysis\":\"hold\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
