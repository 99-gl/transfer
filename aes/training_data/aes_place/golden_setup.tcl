...
#
# Generates only setup.golden.json for the aes_place checkpoint.
...
puts $fh "{\"checkpoint\":\"aes_place.enc\",\"stage\":\"aes_place\",\"analysis\":\"setup\",\"status\":\"ok\",\"startpoint\":\"$startpoint\",\"sta_startpoint_pin\":\"$sta_startpoint\",\"endpoint\":\"$endpoint\",\"slack_ns\":$slack,\"path_group\":\"$path_group\"}"
close $fh
